...
namespace MyWebAPI.Controllers
{
    ...
    public class TheLoaiController : ControllerBase
    {
        ...
        // POST api/theloai
        [HttpPost]
        public async Task<IActionResult> Create(Models.TheLoai input)
        {
        ...
        // PUT api/theloai/{id}
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(string id, [FromBody] Models.TheLoai input)
        {
            using var con = new SqlConnection(_connStr);
            await con.OpenAsync();
